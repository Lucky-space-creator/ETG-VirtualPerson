...
# 嵌入模型（环境变量 BGE_MODEL_PATH 可覆盖路径）
EMBEDDING_MODEL = os.getenv("BGE_MODEL_PATH", os.getenv("EMBEDDING_MODEL", "D:/Milvus/models/BAAI/bge-large-zh-v1___5"))
...
# 向量库路径
VECTOR_DB_PATH = os.getenv("VECTOR_DB_PATH", "D:/Milvus/vectordb/vectors.db")
...
# LLM配置
LLM_API_URL = os.getenv("LLM_API_URL", "https://token-plan-cn.xiaomimimo.com/v1")
LLM_API_KEY = os.getenv("LLM_API_KEY", "tp-cdsqghtr6tyhcu5nojl83ov031l3jtpx9ihn5edpv7oiarj7")
